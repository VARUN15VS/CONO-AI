...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\varun\OneDrive\Desktop\CONO-AI\side_panel_assets\frame0")
...
class Main(Tk):
    def __init__(self):
        ...
        button1 = ctk.CTkButton(button1_frmae, corner_radius = 0, width = 196.0, height = 60.0, text = 'HOME', font = ("Helvetica", 16, "bold"),command = lambda : print("Button-1"), text_color = '#000000', fg_color = '#4DDDE0', hover_color = '#141414', state = 'normal')
        button1.pack(side = 'top', expand = True, fill = 'both')
        button2 = ctk.CTkButton(button2_frmae, corner_radius = 0, width = 196.0, height = 60.0, text = 'MARKET', font = ("Helvetica", 16, "bold"),command = lambda : print("Button-2"), text_color = '#4DDDE0', fg_color = '#000000', hover_color = '#141414', state = 'normal')
        button2.pack(side = 'top', expand = True, fill = 'both')
        button3 = ctk.CTkButton(button3_frmae, corner_radius = 0, width = 196.0, height = 60.0, text = 'ENTERTAINMENT', font = ("Helvetica", 16, "bold"),command = lambda : self.entertainment(frame), text_color = '#4DDDE0', fg_color = '#000000', hover_color = '#141414', state = 'normal')
        button3.pack(side = 'top', expand = True, fill = 'both')
        button4 = ctk.CTkButton(button4_frmae, corner_radius = 0, width = 196.0, height = 60.0, text = 'SETTINGS', font = ("Helvetica", 16, "bold"),command = lambda : print("Button-4"), text_color = '#4DDDE0', fg_color = '#000000', hover_color = '#141414', state = 'normal')
    ...
    def button_selected(self, button1, button2, button3, button4, special, canvas=None, side_canvas=None, c_text=None, c_image=None, h_image=None, m_image=None, s_image=None, e_image=None, event=None):
        ...
        if special == 'no':
            ...
            new_image = PhotoImage(file=relative_to_assets("new_image_2.png"))
            ...
            H_COLOR = '#141414'
            canvas.itemconfigure(side_canvas, fill=COLOR)
            canvas.itemconfigure(c_text, fill='#4DDDE0')
