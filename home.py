...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\varun\OneDrive\Desktop\CONO-AI\home_assets\frame0")
...
class Home(Frame):
    def __init__(self, parent, width=957, height=680):
        ...
        canvas.create_line(574, 145, 674, 45, fill='#4DDDE0', width=5)
        canvas.create_line(674, 45, 684, 45, fill='#4DDDE0', width=5)
        ...
        time_label = ctk.CTkLabel(time_frame, text='00:00', font=('Helvetica', 64, 'bold'), text_color='#4DDDE0', fg_color='#000000')
        time_label.pack(side='top', expand=True, fill='both', padx=5)

        date_label = ctk.CTkLabel(date_frame, text='Sunday, 01 January, 2024', font=('Helvetica', 18, 'bold'), text_color='#4DDDE0', fg_color='#000000')
        ...
        state_label = ctk.CTkLabel(state_frame, text = "Ask me anything!", font = ('Helvetica', 20, 'bold'), text_color = '#4DDDE0', fg_color = '#000000', width = 400)
    ...
    def add_chat_message_speak(self, message, canvas, entry, scrollable_frame, sender="user"):
        ...
        if sender == "user":
            ...
            T_COLOR = "#4DDDE0"
        if message.strip():
            #bubble_color = "#4DDDE0" if sender == "user" else "#333333"
            bubble_color = '#000000'
