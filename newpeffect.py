...
class MovingDots(ctk.CTkFrame):
    def __init__(self, parent, height = 250, width = 250):
        ...
        self.canvas.create_text(125, 125, text="CONO", fill="cyan", font=("Arial", 24, "bold"))
    ...
    def create_arcs(self):
        ...
        self.canvas.create_arc(center_x - radius, center_y - radius,
                               ...
                               start=0, extent=arc_extent, style="arc", outline="cyan", width=3)
        
        self.canvas.create_arc(center_x - radius, center_y - radius,
                               center_x + radius, center_y + radius,
                               start=120, extent=arc_extent, style="arc", outline="cyan", width=3)
        
        self.canvas.create_arc(center_x - radius, center_y - radius,
                               center_x + radius, center_y + radius,
                               start=240, extent=arc_extent, style="arc", outline="cyan", width=3)

        self.canvas.create_arc(center_x - radius, center_y - radius,
                               center_x + radius, center_y + radius,
                               start=360, extent=arc_extent, style="arc", outline="cyan", width=3)
    ...
    def create_dots(self):
        ...
        for i in range(num_dots):
            ...
            dot = self.canvas.create_oval(x - 3, y - 3, x + 3, y + 3, fill="cyan", outline="")
